<template>
    <div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <jet-nav-link :href="route('dashboard')" :active="route().current().startsWith('dashboard')">
                            Dashboard
                        </jet-nav-link>
                        <jet-nav-link :href="route('networks.index')" :active="route().current().startsWith('networks.')">
                            Networks
                        </jet-nav-link>
                    </ul>
        ...
        <main class="container my-5">
            <div v-if="$page.props.flash.visible" :class="$page.props.flash.type" class="alert alert-dismissible fade show" role="alert">
                {{ $page.props.flash.message }}
                <button type="button" v-on:click="$page.props.flash.visible=false" class="btn-close" aria-label="Close"></button>
            </div>
